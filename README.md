...
为了促进中文自然语言处理研究的发展，本项目提供了 **CPM-LM** (2.6B) 模型的文本生成代码，可用于文本生成的本地测试，并以此为基础进一步研究零次学习/少次学习等场景。[[模型下载](https://wudaoai.cn/model/detail/CPM%E7%B3%BB%E5%88%97)] [[技术报告](https://arxiv.org/abs/2012.00413)]
